...
var mainAd = "Do you need help moving? Look no further, get help from our team, from PickUp Truck, to 10T truck, select option 0, to *Book now before the Rush Hour*";
var subCounter = 0;
                                ...
                                if(messages.length > 2){
                                    ...
                                    if(clientMap.has(no)) {
                                        ...
                                        if(query == 0){
                                            ...
                                            messageToSend += `Special Services, tailored just for you \n\n1)Type 1 to be connected to our Furniture Sales Rep  \n2) Type 2 to get connected to our Logistics Team \#) type # to Restart`;
                                            ...
                                            // console.log(ad);
                                            var advert = "";
                                            if(typeof ad._source.adText === "undefined"){
                                                advert = mainAd;
                                            } else {
                                        ...
                                        if(query == 0){
                                            messages.push(query);
                                            messageChain.set(no, messages);
                                            messageToSend += `Special Services, tailored just for you \n\n1)Type 1 to be connected to our Furniture Sales Rep  2) Type 2 to get connected to our Logistics Team \#) type # to Restart`;
                                ...
                                if(messages.length > 3){
                                    ...
                                    if(clientMap.has(no)){  // Client is in system                                  
                                        if(messages[1] == 1){
                                            ...
                                            if(query == 1){
                                                messageToSend +=  `Thank you for reaching out, our sales rep will be in touch with you, *promptly*, or click on this link wa.me/263774407784&text=I%20got%20your%20number%20from%20Consultancy%20Hub.I%20want%20to%20enquire%20about%20furniture`;
                                                ...
                                                messageToSend +=  `Thank you for reaching out, our team will be in touch with you, *promptly*, or click on this link wa.me/263773019194&text=I%20got%20your%20number%20from%20Consultancy%20Hub.I%20want%20to%20enquire%20about%20logistics`;
                                                
                                                client.sendMessage(msg.from,messageToSend).then((res) => {
                                                    // console.log("Res " + JSON.stringify(res));
                                                    var mess = `Good day, wa.me/${no.slice(0, -5)} is interested in your logistics services, click the link to talk to them`;
                                                    client.sendMessage("263773019194@c.us",mess).then((res) => {                                       
